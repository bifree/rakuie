...
<main class="company">
  ...
  <div class="company__about" id="about">
    <div class="container">
      <h2 class="company__title">会社概要</h2>
      <section>
        <h3>社名の由来</h3>
        <div class="company__about--wrap">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/company_name.svg" alt="">
          <p>不動産事業を通じて一日一日を大事に、満ち足りた時間を過ごしていただけるよう『暮らしを楽しく、人々を笑顔にする』会社でありたいという想いから、楽しい家＝ラクイエと名付けました。</p>
        </div>
      </section>
      <section>
        <h3>ロゴの由来</h3>
        <div class="company__about--wrap">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/company_logo.jpg" alt="">
          <div>
      ...
      <table class="company-info">
        ...
        <tr>
          <th>mail</th>
          <td>info@rakuie.jp</td>
        </tr>
        <tr>
          <th>資格</th>
          <td>宅地建物取引士／2級建築施工管理技士／賃貸経営管理士／相続診断士／2級ファイナンシャルプランニング技能士</td>
        </tr>
        <tr>
          <th>免許番号</th>
          <td>大阪府知事(1)第６３０１４号</td>
        </tr>
        <tr>
          <th>加盟協会</th>
          <td>(公社)全日本不動産協会　正会員<br>
              (公社)不動産保証協会　正会員<br>
              (一社)相続診断協会<br>
              日本住宅保証機構　JIO<br>
              新築住宅瑕疵保険加入<br>
  ...
  <div class="company__message parallax" id="message">
    <div class="title">
      <div class="inner">
        <h2>代表挨拶</h2>
      </div>
    ...
    <div class="content">
      <div class="inner">
        <div class="company__message--box">
          <div class="message js-inview">
            <p>弊社ホームページにお越し頂きありがとうございます。<br class="sp-none">株式会社ラクイエ『不動産相続の窓口』代表の前田隆志と申します。</p>
            <p>私が相続専門の不動産会社を立ち上げたのは、自身の経験からです。<br class="sp-none">今後、ますます高齢化社会になり人口の減少が続きます。
              相続問題・空き家問題・地域の過疎化・未登記による所有者不明物件の増加等多くの問題が山積しています。弊社のような相続に特化した不動産会社が、不動産のプロとして何処よりも正確に情報を発信し、安心、安全に相続をワンストップでサポートさせていただく事で顧客満足、社会貢献、地域活性に<br class="sp-none">つながる志しある会社でありたいと考えております。相続不動産を通して、過疎化や空き家<br class="sp-none">問題を解決し、セーフティネットの底上げを使命と考えます。</p>
            <p class="width-long">昨今の相続問題が増加する中で、相続についてのスキーム確立し、士業との連携及び<br class="sp-none">相続不動産売却専門の不動産会社として、大阪府大阪市天王寺区でスタートしました。<br class="sp-none">
              私自身、建築学部を卒業し、建築施工管理、設計・リフォーム業・不動産仲介業・新築<br class="sp-none">一戸建販売業・建築請負業・個人不動産投資家として、20年間『衣・食・住』の住環境<br class="sp-none">に携わって参りました。どのようなご相談・ご質問でも、丁寧に分かり易くを心がけて、<br class="sp-none">ご対応致します。お気軽にお問い合わせください。(しつこい営業は一切致しません)</p>
            <p>士業ネットワークが確立されたことで、相続問題の解決とセーフティーネットの底上げを<br class="sp-none">使命と考え、不動産事業を通じて、地域の発展に携わり社会貢献致します。<br class="sp-none">
              不動産のプロとして最良のご提案をする事をお約束します。<br>
              </p>
            <p class="sign"><small>代表取締役</small>前田 隆志</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="company__access" id="access">
    <div class="container">
      <h2 class="company__title">アクセス</h2>
      <div class="company__access--wrap">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d420125.9754026142!2d135.24020243281248!3d34.64878830000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f0.2!3m3!1m2!1s0x6000ddb7145b1b6d%3A0x8d0ec4ee45879a2a!2z5qCq5byP5Lya56S-44Op44Kv44Kk44Ko!5e0!3m2!1sja!2sjp!4v1639232120303!5m2!1sja!2sjp" width="400" height="400" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        <div>
          <h3>株式会社ラクイエ</h3>
          <p>〒543-0054<br>
					  大阪府大阪市天王寺区南河堀町1-15</p>
        </div>
      </div>
    </div>
  </div>
