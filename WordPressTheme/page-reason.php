    ...
    <div class="reason-container">
        ...
        <article>
            ...
            <div class="reason_3 reason_box">
                <div class="box_inner">
                    <div class="left">
                        <h2 class="title">
                            <span>ノルマなしだから<br>売主様の利益を第一に考えられる</span>
                        </h2>
                        <div class="list">
                            <ul>
            ...
            <div class="reason_6 reason_box green_bg">
                <div class="box_inner">
                    <div class="left">
                        <h2 class="title">
                            <span>契約不適合責任なし</span>
				...
				<div class="inner">
					<div class="wrapItems js-inview">
						<dl class="item">
							...
							<dd>
								<p class="ttl">
									多様な専門家との連携により、<br class="is_pc">お客様があちこち相談に行く手間と時間が省けます。
								</p>
							</dd>
						</dl>
						<dl class="item">
							...
							<dd>
								<p class="ttl">
									ノルマを撤廃し、<br class="is_pc">お客様に寄り添ったご提案をさせていただきます。
								</p>
							</dd>
						</dl>
						<dl class="item">
        ...
        <div class="tokuten" id="tokuten">
            ...
            <div class="intro">
                ...
                <br>ラクイエなら、下記のような特典があり、あなたの売却を徹底サポートいたします。
                </p>
            </div>
            <div class="tokuten">
                <div class="item">
