      ...
      <div class="merit" id="merit">
        <div class="merit__intro">
          ...
          <div class="inner">
                ...
                ≪一般の不動産会社≫<br>
                ・ノルマがあるから売却を急がせる<br>
                ・根拠のない査定価格の説明大丈夫です。売れます。など<br>
                <br>
                【相続不動産の窓口】<br>
                ノルマがないから売主様のご希望販売価格を重視して納得ご満足できる売買にするため、しかりとした相場をお伝えいたします。<br>
								</p>
							</dd>
						</dl>
						<dl class="item">
							<dt>押し売りでなくご説明を致します</dt>
							<dd>
								<p class="ttl">
                ≪一般の不動産会社≫<br>
                ・商売につなげる説明をする<br>
                ...
                <br>
                【相続不動産の窓口】<br>
                売主様の立場に立ち第3者の公平な立場で説明します。<br>
                各士業と連携があるため公平な情報をまずはしかりとお伝えします。
								</p>
							</dd>
						</dl>
						<dl class="item">
							<dt>事務的・法的処理にも責任を持ちます</dt>
							<dd>
								<p class="ttl">
                ≪一般の不動産会社≫<br>
                ・税金や登記のことは外部に委託<br>
                ・紹介後は問題がおきても無責任になる<br>
                <br>
                【相続不動産の窓口】<br>
                登記もワンストップで対応<br>
                ラクイエが窓口と成り司法書士の先生をご紹介させていただきます。<br>
                ご不満や問題は、弊社が責任を持ってご対応いたします。
								</p>
							</dd>
						</dl>
						<dl class="item">
                ...
                ≪一般の不動産会社≫<br>
                ・財務状況を考慮した話は困難<br>
                ・相談するのに有料又は1回の相談のみで丸投げ状態<br>
                <br>
                【相続不動産の窓口】<br>
                税理士が同席して、相続税等について無料相談できます。<br>
                メリット・デメリットを税理士が考慮して、最良なご提案をご一緒に
                検討していきます。
								</p>
							</dd>
						</dl>
        ...
        <div class="inner">
          <div class="trouble">
            ...
            <div class="about-rakuie">
              ...
              <p>私たちラクイエは、売主様のご状況やご要望をしっかりとお聞きし、売主様のご希望に添えるように二人三脚で取り組みます。</p>
              <p>従来の売却手法ではなく売主様に安心して不動産を売却いただける独自の仕組みでお客様から選ばれています。</p>
          ...
          <div class="inner">
            ...
            <div class="wrapper">
              <div class="item">
                ...
                <p>相続人の特定は、亡くなられた方の出生から死亡した時までの時までの戸籍、除籍、改正原戸籍謄本を確認していただきます。売却するには相続登記を完了しなければなりません。</p>
              </div>
              <div class="item">
                <h4>物件の敷地境界線の確認</h4>
                <p>敷地境界標がある場合は、登記測量図面と敷地の照合を行い、隣地所有者と立ち会って境界の確認、確定を行います。境界標があって測量図面がない場合や境界標がなくて測量図面がある場合、そのどちらもない場合があります。</p>
                <p>どのケースでも境界を特定する必要があります。売却の条件として境界標の設置や測量、地積更生などが必要になる時は、費用が発生する場合があります。</p>
              </div>
            </div>
          </div>
        </div>
