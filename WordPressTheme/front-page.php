	...
	<main id="main">
		<div class="container">
			<div class="rakuie-omakase">
				...
				<p>『司法書士・行政書士・宅地建物取引士・相続診断士』の<br><strong>専門資格の連携</strong>で<br>
					多様な相続不動産のケースにご対応が可能です。</p>
				<p>相続には時として、さまざまな専門家の力が必要になります。<br>
					相続に関する専門家の取りまとめ、窓口役となり<br>
					事務手続きや提携士業との連携で<br>
				...
				<div class="inner">
					<div class="wrapItems">
						<dl class="item">
							...
							<dd>
								<p class="ttl">
									多様な専門家との連携により、<br>お客さまがあちこち相談に行く手間と時間が省けます。
								</p>
							</dd>
						</dl>
						<dl class="item">
							...
							<dd>
								<p class="ttl">
									ノルマを撤廃し、<br>お客さまに寄り添ったご提案をさせていただきます。
								</p>
							</dd>
						</dl>
						<dl class="item">
							...
							<dd>
								<p class="ttl">
									相続以外にも、<br>リフォーム依頼・新築一戸建て建築相談等もお任せください。
								</p>
							</dd>
						</dl>
						<dl class="item">
							...
							<dd>
								<p class="ttl">
									専門用語を使わず、<br>ご理解・ご納得いただけるまでご対応させていただきます。
								</p>
							</dd>
						</dl>
					</div>
